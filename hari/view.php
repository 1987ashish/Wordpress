...
$knowingkentemployees = mysqli_query($conn,"SELECT count(*) as cnt FROM `details_of_knowing_any_kent_employee` WHERE uid = ".$_GET['id']."");
                      ...
                      <!--<div class="tools">
                        ...
                        <a href="javascript:;" class="remove">
									...
									if(isset($_GET['succ']) == 1){
										...
										echo '<div id ="successMessage" class="alert alert-success"><strong>Success!</strong>You have successfull registerd.</div>';
										?>
										<script>
										   setTimeout(function() {
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <input type="text" maxlength="12"  id="adharno"  class="form-control" value="<?php echo $detail['adharno'] ?>"  disabled name ="adharno" placeholder="">
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group">
                                <label class="control-label">PAN NO.</label>
                                <input type="text" id="pan_number" class="form-control" onblur="return validatePanNumber(this.value);" value="<?php echo $detail['pan_number'] ?>" disabled  style="text-transform: uppercase" name ="pan_number"  placeholder="" >
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <input type="text" maxlength="12" id="uanno" class="form-control" value="<?php echo $detail['uanno'] ?>" disabled name ="uanno"  placeholder="">
                              </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <input type="text" id="esino" maxlength="10" class="form-control" value="<?php echo $detail['esino'] ?>"  disabled onkeypress='return isNumberKey(event)' name ="esino"  placeholder="">
                              </div>
                            </div>
                            <!--/span-->
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md-4">
                              <div class="form-group">
                                ...
                                <input type="text" id="firstName" class="form-control" value="<?php echo $detail['bank_number'] ?>" disabled name ="bank_number"  placeholder="">
                              </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-4">
                              <div class="form-group">
                                ...
                                <input type="text" id="bankaccount" class="form-control"   value="<?php echo $detail['bank_account'] ?>" disabled onkeypress='return isNumberKey(event)' name ="bank_account"  placeholder="">
                              </div>
                            </div>
                            <div class="col-md-4">
                              <div class="form-group">
                                <label class="control-label">IFSC Code No.</label>
                                <input type="text" id="ifsc_number" class="form-control" value="<?php echo $detail['ifsc_number'] ?>" disabled onkeyup="return validatePanNumber();"  name ="ifsc_number"  placeholder="">
                                <div id="ifccode"></div>
                              </div>
                            </div>
                            <!--/span-->
						  ...
						  <label class="forml" style="border-bottom: 1px solid #eee; ">*Name should be same as given in aadhar card.</label>
												<div class="row">
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" id="firstName"  class="form-control" disabled value="<?php echo $detail['firstname'] ?>" name ="firstname" placeholder="">
													...
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" id="secondname"  class="form-control" disabled value="<?php echo $detail['secondname'] ?>" name ="secondname"  placeholder="">
													...
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" id="lastName" class="form-control" disabled value="<?php echo $detail['lastname'] ?>" name ="lastname"  placeholder="">
													...
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" id="dob_user" disabled class="form-control" value="<?php echo $detail['dob'] ?>"  name ="dob"  placeholder="">
													...
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" id="doj_user" class="form-control" disabled value="<?php echo $detail['doj'] ?>"  name ="doj"  placeholder="">
													...
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" id="blood_group" class="form-control" disabled value="<?php echo $detail['blood_group'] ?>" name ="blood_group"   placeholder="">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" id="fatherName" class="form-control" disabled value="<?php echo $detail['fathername'] ?>"  name ="fathername"  placeholder="">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" id="husbabandname" class="form-control" disabled value="<?php echo $detail['husband_wife_name'] ?>"  name ="husband_wife_name"  placeholder="">
														</div>
													</div>
													<!--/span-->
												</div>
												<div class="row">
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="email" id="firstName" class="form-control" disabled value="<?php echo $detail['persional_email_id'] ?>" name ="persional_email_id"  placeholder="">
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="gender" id="gender" class="form-control" disabled value="<?php echo $detail['gender'] ?>" name ="gender"   placeholder="">
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" id="mobileno" class="form-control" maxlength="10" disabled value="<?php echo $detail['mobile_number'] ?>" name ="mobile_number" placeholder="">
                              ...
                              <div class="form-group">
								...
								<input type="matital_status" id="matital_status" class="form-control" disabled value="<?php echo $detail['matital_status'] ?>" name ="matital_status"   placeholder="">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" name ="corresp_house_address" disabled value="<?php echo $detail['corresp_house_address'] ?>" class="form-control">
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															<label>Colony</label>
															<input type="text" name ="corresp_colony" disabled value="<?php echo $detail['corresp_colony'] ?>" class="form-control">
														</div>
													</div>
													<!--/span-->
												</div>
                              ...
                              <div class="form-group">
                                <label>State</label>
                                <select name ="corresp_state" id="corresp_state" disabled class="form-control valid">
                                    ...
                                    ?> 
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" name ="corresp_city" id="cityid_customer" disabled value="<?php echo $detail['corresp_city'] ?>" class="form-control">
													...
													<div class="col-md-4">
														<div class="form-group">
															<label>Pincode</label>
															<input type="number" name ="corresp_pincode" disabled value="<?php echo $detail['corresp_pincode'] ?>"  class="form-control">
														</div>
													</div>
													<!--/span-->
												</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label>House/Plot/Gali/Floor/Sector</label>
															<input type="text" name ="pernt_house_address" disabled value="<?php echo $detail['pernt_house_address'] ?>"  class="form-control">
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															<label>Colony</label>
															<input type="text" name ="pernt_corresp_colony" disabled value="<?php echo $detail['pernt_corresp_colony'] ?>"  class="form-control">
														</div>
													</div>
													<!--/span-->
												</div>
												...
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group">
															<label>State</label>
															<select name ="pernt_corresp_state" id="pernt_corresp_state"  disabled class="form-control valid">
															<option value="" >Select state</option>
																  <?php 
                                  ...
                                  <?php
                                    ...
                                    ?> 
													...
													<div class="col-md-4">
														<div class="form-group">
															<label>District/City</label>
															<input type="text" name ="pernt_corresp_city" id="cityid_customer_second" disabled value="<?php echo $detail['pernt_corresp_city'] ?>" class="form-control">
													...
													<div class="col-md-4">
														<div class="form-group">
															<label>Pincode</label>
															<input type="number" name ="pernt_corresp_pincode" disabled value="<?php echo $detail['pernt_corresp_pincode'] ?>" class="form-control">
														</div>
													</div>
													<!--/span-->
												</div>
												...
												<div class="row">
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" id="qualification" disabled name="qualification[]"  value ="<?php echo $qualdetail['qualification'] ?>" class="form-control" placeholder="">
													...
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" id="college" name="college[]" disabled value ="<?php echo $qualdetail['college'] ?>"  class="form-control" placeholder="">
													...
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" id="afliliated" name="afliliated[]" disabled value ="<?php echo $qualdetail['year_form'] ?>" class="form-control" placeholder="">
													...
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" id="to_form" name="to_form[]" disabled  value ="<?php echo $qualdetail['year_to'] ?>" class="form-control" placeholder="">
													...
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" id="year_to" name ="year_to[]" disabled  value ="<?php echo $qualdetail['year_to'] ?>" class="form-control" placeholder="">
													...
													<div class="col-md-2">
														<div class="form-group">
															...
															<input type="text" id="year_per" name ="year_per[]" disabled value ="<?php echo $qualdetail['percentage'] ?>"  class="form-control" placeholder="">
                            ...
                            <div class="row">
                              <div class="col-md-2">
                                <div class="form-group">
                                  ...
                                  <input type="text" id="organization" name ="organization[]" disabled value ="<?php echo $preemployment['organization']?>" class="form-control" placeholder="">
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">Service From</label>
                                  <input type="text" id="service_from" name ="service_from[]" disabled value ="<?php echo $preemployment['service_from']?>" class="form-control " placeholder=""  >
                                </div>
                              </div>
                              <!--/span-->
                              <div class="col-md-2">
                                <div class="form-group">
                                  ...
                                  <input type="text" id="service_to" name ="service_to[]"   disabled value ="<?php echo $preemployment['service_to']?>" onkeyup ="getdatevalidate()"  class="form-control" placeholder="" >
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">Total Service Period</label>
                                  <input type="text" id="serviceperiod" name ="total_service[]" disabled value ="<?php echo $preemployment['total_service']?>"  class="form-control" placeholder="">
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">Designation</label>
                                  <input type="text" id="firstName" name ="designation[]"  disabled value ="<?php echo $preemployment['designation']?>" class="form-control" placeholder="">
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">Gross Salary*</label>
                                  <input type="text" id="firstName" name ="gross_salary[]"  disabled value ="<?php echo $preemployment['gross_salary']?>" class="form-control" placeholder="">
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label class="control-label">Responsibilities**</label>
                                  <input type="text" id="firstName" name ="responsibilities[]"  disabled value ="<?php echo $preemployment['responsibilities']?>" class="form-control" placeholder="">
                                </div>
                              </div>
                              <!--/span-->
                            </div>
                            ...
                            <div class="row">
                              <div class="col-md-2">
                                <div class="form-group">
                                  ...
                                  <input type="text" id="family_name" name="family_name[]" disabled value ="<?php echo $family['family_name']?>" class="form-control" placeholder="">
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">D.O.B.</label>
                                  <input type="text" id="dobirth1" name="dobirth[]" disabled value ="<?php echo $family['dobirth']?>" class="form-control" placeholder="" >
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label class="control-label">Email Id</label>
                                  <input type="email" id="family_email_id1" class="form-control" disabled value ="<?php echo $family['family_email_id']?>"  name ="family_email_id[]"  placeholder="">
                                </div>
                              </div>
                              <!--/span-->
                              <div class="col-md-1">
                                <div class="form-group">
								  ...
								  <input type="text" id="family_relationship" name="family_relationship[]" disabled value ="<?php echo $family['family_relationship']?>" class="form-control" placeholder="" >
                              ...
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">Aadhar Card No.</label>
                                  <input type="text" maxlength="12"  id="family_aadharno1"  class="form-control" disabled value ="<?php echo $family['family_aadharno']?>"   name ="family_aadharno[]" placeholder="">
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">Mobile No.</label>
                                  <input type="text" id="family_mobileno1" maxlength="10"  name="family_mobileno[]" disabled value ="<?php echo $family['family_mobileno']?>" onkeypress='return isNumberKey(event)' class="form-control" placeholder="" >
                                </div>
                              </div>
						...
						?>
                            <div class="row">
							  ...
							  $checked1 = $checked2 ='';
                                if(!empty($data[0]['member']) == 'Yes'){
									$checked1 = 'checked';
								}else{
									$checked2 = 'checked';
								}
								if(!empty($data[0]['member']) === 'No'){
									$checked2 = 'checked';
								}
							  ?>
                              <div class="col-md-3">
                              ...
                              <div class="col-md-3">
                                <div class="form-group">
                                  ...
                                  <input type="text" disabled id="membershipno1" name= "membership_no1" value ="<?php echo !empty($data[0]['membership_no']) ? $data[0]['membership_no'] : ''?>" class="form-control" placeholder="">
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label class="control-label">Name Of Organization & Position</label>
                                  <input type="text" disabled id="position1" value ="<?php echo !empty($data[0]['position']) ? $data[0]['position'] : '' ?>" name= "position1" class="form-control" placeholder="">
                                </div>
                              </div>
                            </div> 
                            <div class="row">
							  ...
							  $checked3 = $checked4 ='';
                                if(!empty($data[1]['member']) == 'Yes'){
									$checked3 = 'checked';
								}else{
									$checked4 = 'checked';
								}
								if(!empty($data[1]['member']) === 'No'){
									$checked4 = 'checked';
								}
							  ?>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <div class="radio-list">
                                    ...
                                    <label class="radio-inline">
                                    <input type="radio" value="No" <?php echo $checked4; ?> onclick="checkmember4()" id="optionsRadios44"  name= "member2"   > No </label>
                                  </div>
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <input type="text" disabled id="membershipno2" name= "membership_no2" value ="<?php echo !empty($data[1]['membership_no'])  ?  $data[1]['membership_no'] : ''?>" class="form-control" placeholder="">
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <input type="text" disabled id="position2" name= "position2" value ="<?php echo !empty($data[1]['position']) ?  $data[1]['position'] : ''?>"  class="form-control" placeholder="">
                                </div>
                              </div>
                            </div>
                            <div class="row">
							  ...
							  $checked5 = $checked6 ='';
                                if(!empty($data[2]['member']) == 'Yes'){
									$checked5 = 'checked';
								}else{
									$checked6 = 'checked';
								}
								if(!empty($data[2]['member']) === 'No'){
									$checked6 = 'checked';
								}
							  ?>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <div class="radio-list">
                                    <label class="radio-inline">
                                    <input type="radio"   <?php echo $checked5; ?> value="Yes" onclick="checkmember5()" id="optionsRadios55"  name= "member3"   > Yes </label>
                                    <label class="radio-inline">
                                    <input type="radio"   <?php echo $checked6; ?> value="No" onclick="checkmember6()" id="optionsRadios66"   name= "member3" > No </label>
                                  </div>
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <input type="text" disabled id="membershipno3" name= "membership_no3" value ="<?php echo !empty($data[2]['membership_no']) ?  $data[2]['membership_no'] : ''?>" class="form-control" placeholder="">
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <input type="text" disabled id="position3" name= "position3"  value ="<?php echo !empty($data[2]['position']) ? $data[2]['position'] : '' ?>" class="form-control" placeholder="">
                                </div>
                              </div>
                            </div>
                            <div class="row">
							  ...
							  $checked7 = $checked8 ='';
                                if(!empty($data[3]['member']) == 'Yes'){
									$checked7 = 'checked';
								}else{
									$checked8 = 'checked';
								}
								if(!empty($data[3]['member']) === 'No'){
									$checked8 = 'checked';
								}
							  ?>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <div class="radio-list">
                                    ...
                                    <label class="radio-inline">
                                    <input type="radio" value="No"  <?php echo $checked8; ?> onclick="checkmember8()" id="optionsRadios88"  name= "member4" > No </label>
                                  </div>
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <input type="text" disabled id="membershipno4" value ="<?php echo !empty($data[3]['membership_no']) ?  $data[3]['membership_no'] : ''?>" name= "membership_no4" class="form-control" placeholder="">
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <input type="text" disabled id="position4" value ="<?php echo !empty($data[3]['position']) ?  $data[3]['position'] : ''?>" name= "position4" class="form-control" placeholder="">
                                </div>
                              </div>
                            </div>
                          </div>
							...
							<?php 
			                  $detailsofknowings = mysqli_fetch_assoc($knowingkentemployees);
							  if($detailsofknowings['cnt'] > 0){
                            ...
                            <div class="row">
                              <div class="col-md-2">
                                <div class="form-group">
                                  ...
                                  <input type="text" id="firstName" name="reference_name[]"  value= "<?php echo $detailsofknowing['reference_name']?>" disabled class="form-control" placeholder="">
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">EMPLOYEE. Code</label>
                                  <input type="text" id="emp_code" name="emp_code[]" class="form-control"  value= "<?php echo $detailsofknowing['emp_code']?>" disabled maxlength="7" onkeypress='return isNumberKey(event)' placeholder="">
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">Designation</label>
                                  <input type="text" id="firstName" name="designation[]" value= "<?php echo $detailsofknowing['designation']?>" disabled class="form-control" placeholder="">
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">Department</label>
                                  <input type="text" id="firstName" name="department[]" value= "<?php echo $detailsofknowing['department']?>" disabled class="form-control" placeholder="">
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">Relationship</label>
								    <input type="text" id="kent_relationship" name="kent_relationship[]" value= "<?php echo $detailsofknowing['kent_relationship']?>" disabled class="form-control" placeholder="">
                              ...
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">Mobile No.</label>
                                  <input type="text" id="kent_mobile_no" maxlength="10"  value= "<?php echo $detailsofknowing['kent_mobile_no']?>" disabled name="kent_mobile_no[]" onkeypress='return isNumberKey(event)' class="form-control" placeholder="">
                                </div>
                              </div>
                              <!--/span-->
                            </div>
							<?php } } else { ?>
							 ...
							 <div class="row">
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">Reference Name</label>
                                  <input type="text" id="firstName" name="reference_name[]" class="form-control" disabled placeholder="">
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">EMPLOYEE. Code</label>
                                  <input type="text" id="emp_code" name="emp_code[]" class="form-control"  maxlength="7" onkeypress='return isNumberKey(event)' disabled placeholder="">
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">Designation</label>
                                  <input type="text" id="firstName" name="designation[]" class="form-control" disabled placeholder="">
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">Department</label>
                                  <input type="text" id="firstName" name="department[]" class="form-control" disabled placeholder="">
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">Relationship</label>
                                  <select name ="kent_relationship[]" disabled class="form-control">
                              ...
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label class="control-label">Mobile No.</label>
                                  <input type="text" id="kent_mobile_no" maxlength="10"  name="kent_mobile_no[]" onkeypress='return isNumberKey(event)' disabled class="form-control" placeholder="">
                                </div>
                              </div>
                              <!--/span-->
                            </div>
							<div class="row">
                              ...
                              <div class="col-md-2">
                                <div class="form-group">
                                  <input type="text" id="emp_code" name="emp_code[]"  maxlength="7" class="form-control" onkeypress='return isNumberKey(event)' disabled placeholder="">
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="form-group">
                              ...
                              <div class="col-md-2">
                                <div class="form-group">
                                  <input type="text" id="kent_mobile_no1" maxlength="10" name="kent_mobile_no[]" onkeypress='return isNumberKey(event)' disabled class="form-control" placeholder="">
                                </div>
                              </div>
                              <!--/span-->
                            </div>
						  ...
						  <div class="form-body">
                           <h3 class="form-section"><strong> HAVE YOU EVER BEEN CONVICTED IN A COURT OF LAW. IF YES, GIVE DETAILS:</strong> </h3>
                            <div class="row">
							 ...
							 <div class="col-md-12">
                                <div class="form-group">
                                  <textarea class="form-control"  id="convicted" name="convicted"  disabled  rows="3"> <?php echo $detail['convicted'] ?> </textarea>
                                </div>
                              </div>
                            </div>
							...
							<div class="row">
							 <div class="col-md-2">
                                <div class="form-group">
                                  ...
                                  <input type="text" id="place" name="place" class="form-control" value="<?php echo $detail['place'] ?>"  disabled  placeholder="">
                                </div>
                              </div>
							...
							<div class="row">
							 <div class="col-md-2">
                                <div class="form-group">
                                  ...
                                  <input type="text" id="date" name="date" class="form-control"  value="<?php echo $detail['date'] ?>"  disabled  placeholder="MM/DD/YYYY">
                                </div>
                              </div>
